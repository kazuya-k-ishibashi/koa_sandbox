...
export default class InMemoryDataBase {
  ...
  constructor() {
      this.users [
        { id: 1, code: uuid(), role: 1 },
        { id: 2, code: uuid(), role: 2 },
        { id: 3, code: uuid(), role: 2 },
        { id: 4, code: uuid(), role: 3 },
        { id: 5, code: uuid(), role: 3 },
      ]
      this.roles: = [
        { id: 1, name: '管理者', descriptioin: '管理者です' },
        { id: 2, name: '弁護士', descriptioin: '弁護士です' },
        { id: 3, name: '相談者', descriptioin: '相談者です' },
      ]
      this.lawyerDetails = [
